            ...
            <div className="flex-1">
              ...
              <div className="mt-8">
                ...
                <p className="mt-6 text-sm text-center text-gray-400">
                  ¿Aún no tienes una cuenta? <button className="text-blue-500 focus:outline-none focus:underline hover:underline">Registrate con tu correo electrónico</button>.
                </p>
              </div>
            </div>
          </div>
